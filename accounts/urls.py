...
urlpatterns = [
    path('accounts/login/', TemplateView.as_view(template_name='login.html'), name='account_login'),
    path('accounts/logout/', TemplateView.as_view(template_name='logout.html'), name='account_logout'),
    path('accounts/signup/', TemplateView.as_view(template_name='signup.html'), name='account_signup'),
